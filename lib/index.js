  ...
  if (code) {
    ...
    axios.post(url, querystring.stringify(requestBody), config)
      .then((res) => {
        ...
        console.log(chalk.green('Your client auth token is: '), chalk.bold(clientToken))
        console.log(chalk.green('Your temporary access token is: '), chalk.bold(access_token))
